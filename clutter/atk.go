...
func (_self_ *AtkText) GetCharacterExtents(offset int, x *C.gint, y *C.gint, width *C.gint, height *C.gint, coords int) () {
	_cgo_offset_ := (C.gint)(offset)
...
func (_self_ *AtkText) GetOffsetAtPoint(x int, y int, coords int) (_go__return__ int) {
	_cgo_x_ := (C.gint)(x)
	_cgo_y_ := (C.gint)(y)
	var _return_ C.gint
	_cgo_coords_ := (C.AtkCoordType)(coords)
...
func (_self_ *AtkText) GetRangeExtents(start_offset int, end_offset int, coord_type int, rect *TextRectangle) () {
	_cgo_rect_ := (*C.AtkTextRectangle)(unsafe.Pointer(rect))
	_cgo_start_offset_ := (C.gint)(start_offset)
	_cgo_end_offset_ := (C.gint)(end_offset)
	_cgo_coord_type_ := (C.AtkCoordType)(coord_type)
...
func (_self_ *AtkText) GetTextAfterOffset(offset int, boundary_type int, start_offset *C.gint, end_offset *C.gint) (_go__return__ string) {
	_cgo_offset_ := (C.gint)(offset)
	var _return_ *C.gchar
...
func (_self_ *AtkText) GetTextAtOffset(offset int, boundary_type int, start_offset *C.gint, end_offset *C.gint) (_go__return__ string) {
	_cgo_offset_ := (C.gint)(offset)
	var _return_ *C.gchar
	_cgo_boundary_type_ := (C.AtkTextBoundary)(boundary_type)
...
func (_self_ *AtkText) GetTextBeforeOffset(offset int, boundary_type int, start_offset *C.gint, end_offset *C.gint) (_go__return__ string) {
	_cgo_offset_ := (C.gint)(offset)
	var _return_ *C.gchar
	_cgo_boundary_type_ := (C.AtkTextBoundary)(boundary_type)
