// this file is auto-generated by go-gi at 2012-11-23 01:38:26
...
func AcceleratorGetLabel(accelerator_key C.guint, accelerator_mods C.GdkModifierType) string {
	return C.GoString((*C.char)(C.gtk_accelerator_get_label(accelerator_key, accelerator_mods)))
}

func AcceleratorGetLabelWithKeycode(display *C.GdkDisplay, accelerator_key C.guint, keycode C.guint, accelerator_mods C.GdkModifierType) string {
	return C.GoString((*C.char)(C.gtk_accelerator_get_label_with_keycode(display, accelerator_key, keycode, accelerator_mods)))
}

func AcceleratorName(accelerator_key C.guint, accelerator_mods C.GdkModifierType) string {
	return C.GoString((*C.char)(C.gtk_accelerator_name(accelerator_key, accelerator_mods)))
}

func AcceleratorNameWithKeycode(display *C.GdkDisplay, accelerator_key C.guint, keycode C.guint, accelerator_mods C.GdkModifierType) string {
	return C.GoString((*C.char)(C.gtk_accelerator_name_with_keycode(display, accelerator_key, keycode, accelerator_mods)))
}
...
func AcceleratorParse(accelerator string, accelerator_key *C.guint, accelerator_mods *C.GdkModifierType) {
	...
	C._gtk_accelerator_parse(unsafe.Pointer(_gstr_accelerator), accelerator_key, accelerator_mods)
}
...
func AcceleratorParseWithKeycode(accelerator string, accelerator_key *C.guint, accelerator_codes unsafe.Pointer, accelerator_mods *C.GdkModifierType) {
	...
	defer C.free(_cstr_accelerator)
	_gstr_accelerator := (*C.gchar)(unsafe.Pointer(_cstr_accelerator))
	C._gtk_accelerator_parse_with_keycode(unsafe.Pointer(_gstr_accelerator), accelerator_key, unsafe.Pointer(accelerator_codes), accelerator_mods)
}
...
func BindingEntryAddSignall(binding_set *C.GtkBindingSet, keyval C.guint, modifiers C.GdkModifierType, signal_name string, binding_args *C.GSList) {
	...
	C._gtk_binding_entry_add_signall(binding_set, keyval, modifiers, unsafe.Pointer(_gstr_signal_name), binding_args)
}
...
func CheckVersion(required_major C.guint, required_minor C.guint, required_micro C.guint) string {
	return C.GoString((*C.char)(C.gtk_check_version(required_major, required_minor, required_micro)))
}
...
func DragSetIconName(context *C.GdkDragContext, icon_name string, hot_x C.gint, hot_y C.gint) {
	...
	C._gtk_drag_set_icon_name(context, unsafe.Pointer(_gstr_icon_name), hot_x, hot_y)
}
...
func DragSetIconStock(context *C.GdkDragContext, stock_id string, hot_x C.gint, hot_y C.gint) {
	...
	C._gtk_drag_set_icon_stock(context, unsafe.Pointer(_gstr_stock_id), hot_x, hot_y)
}
...
func IconSizeGetName(size C.GtkIconSize) string {
	return C.GoString((*C.char)(C.gtk_icon_size_get_name(size)))
}
...
func IconSizeRegister(name string, width C.gint, height C.gint) C.GtkIconSize {
	_cstr_name := unsafe.Pointer(C.CString(name))
	defer C.free(_cstr_name)
	_gstr_name := (*C.gchar)(unsafe.Pointer(_cstr_name))
	return C._gtk_icon_size_register(unsafe.Pointer(_gstr_name), width, height)
}
...
func InitWithArgs(argc *C.gint, argv unsafe.Pointer, parameter_string string, entries *C.GOptionEntry, translation_domain string, err unsafe.Pointer) C.gboolean {
	...
	return C._gtk_init_with_args(argc, unsafe.Pointer(argv), unsafe.Pointer(_gstr_parameter_string), entries, unsafe.Pointer(_gstr_translation_domain), unsafe.Pointer(err))
}
...
func PaperSizeGetDefault() string {
	return C.GoString((*C.char)(C.gtk_paper_size_get_default()))
}
...
func ShowUri(screen *C.GdkScreen, uri string, timestamp C.guint32, err unsafe.Pointer) C.gboolean {
	_cstr_uri := unsafe.Pointer(C.CString(uri))
	defer C.free(_cstr_uri)
	_gstr_uri := (*C.gchar)(unsafe.Pointer(_cstr_uri))
	return C._gtk_show_uri(screen, unsafe.Pointer(_gstr_uri), timestamp, unsafe.Pointer(err))
}
...
func StockLookup(stock_id string, item *C.GtkStockItem) C.gboolean {
	_cstr_stock_id := unsafe.Pointer(C.CString(stock_id))
	defer C.free(_cstr_stock_id)
	_gstr_stock_id := (*C.gchar)(unsafe.Pointer(_cstr_stock_id))
	return C._gtk_stock_lookup(unsafe.Pointer(_gstr_stock_id), item)
}

func StockSetTranslateFunc(domain string, _func C.GtkTranslateFunc, data C.gpointer, notify C.GDestroyNotify) {
	_cstr_domain := unsafe.Pointer(C.CString(domain))
	defer C.free(_cstr_domain)
	_gstr_domain := (*C.gchar)(unsafe.Pointer(_cstr_domain))
	C._gtk_stock_set_translate_func(unsafe.Pointer(_gstr_domain), _func, data, notify)
}
...
func TestTextGet(widget *C.GtkWidget) string {
	return C.GoString((*C.char)(C.gtk_test_text_get(widget)))
}

func TestTextSet(widget *C.GtkWidget, string string) {
	_cstr_string := unsafe.Pointer(C.CString(string))
	defer C.free(_cstr_string)
	_gstr_string := (*C.gchar)(unsafe.Pointer(_cstr_string))
	C._gtk_test_text_set(widget, unsafe.Pointer(_gstr_string))
}
